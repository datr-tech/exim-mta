...
#####################################################################
#                                                                   #
# Script:  tls_starttls_auth_positive.test.sh                       #
#                                                                   #
# Purpose: A set of positive TLS tests with auth                    #
#                                                                   #
...
# data_provider test_tls_starttls_auth_positive_fixtures
function test_tls_starttls_auth_positive() {
  ...
  local -r test_name="test_tls_starttls_auth_positive"
...
function test_tls_starttls_auth_positive_fixtures() {
