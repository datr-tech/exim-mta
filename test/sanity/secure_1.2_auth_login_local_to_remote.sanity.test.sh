...
function test_sanity_secure_1.2_auth_login_local_to_remote() {
  ...
  local -r sanity_test_name="test_sanity_secure_1.2_auth_login_local_to_remote"
  ...
  local -r email_address_to="${BOOTSTRAP_EMAIL_REMOTE}"
