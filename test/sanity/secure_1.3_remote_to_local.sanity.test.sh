...
function test_sanity_secure_1.3_remote_to_local() {
  ...
  local -r sanity_test_name="test_sanity_secure_1.3_remote_to_local"

  ###################################################################
  #                                                                 #
  # 1.3  Mail server vars                                           #
  #                                                                 #
  ###################################################################

  local -r mail_server_name="${BOOTSTRAP_DOMAIN_LOCAL}"
  local -i -r mail_server_port="${BOOTSTRAP_EXIM_SECURE_PORT}"
  local -r mail_server_tls_version="${BOOTSTRAP_TLS_1_3}"
